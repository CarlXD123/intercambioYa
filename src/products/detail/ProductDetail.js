      ...
      <div className="row mb-4">
        ...
        <div className="col-lg-5">
          <div className="d-flex flex-column h-100">
            ...
            <hr />
            <dl className="row">
              <dt className="col-sm-4">Codigo</dt>
              <dd className="col-sm-8 mb-3">C0001</dd>

              <dt className="col-sm-4">Categoria</dt>
              <dd className="col-sm-8 mb-3">Tecnologia</dd>

              <dt className="col-sm-4">Color</dt>
              <dd className="col-sm-8 mb-3">Negro</dd>
            ...
            <p className="lead flex-shrink-0">
              <small>
               Laptop en buenas condiciones, solo lleva 2 meses de uso.
              </small>
            </p>
          </div>
        </div>
